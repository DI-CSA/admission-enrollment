      ...
      blocos: [
        ...
        },
        {
          ...
          itens: [
            ...
            "Agendamento de visitas: área destinada a marcar uma visita presencial ao colégio. Os dados solicitados são: nome, e-mail, telefone (opcional) e segmento/série de interesse. A hipótese de tratamento é o seu consentimento, previsto no art. 7º, I, da LGPD. Com sua autorização de marketing, os dados da visita podem ser usados para contato sobre a admissão e para medição de campanhas. O prazo de armazenamento é de 1 (um) ano após a data da visita.",
          ],
        },
        {
          tipo: "p",
